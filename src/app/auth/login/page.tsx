...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-slate-50 text-slate-950 dark:bg-[#030712] dark:text-white">
      ...
      <div className="relative mx-auto grid min-h-[100dvh] max-w-7xl grid-cols-1 items-center gap-10 px-4 py-8 sm:px-6 lg:grid-cols-[1fr_480px] lg:px-8">
        <section className="hidden lg:flex min-h-[760px] flex-col justify-between rounded-[2rem] border border-white/10 bg-slate-950 p-10 text-white shadow-2xl shadow-slate-950/25 overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl" data-reveal>
            ...
            <h1 className="max-w-lg text-5xl font-black leading-[1.02] tracking-tight">
          ...
          <div className="rounded-[1.75rem] border border-white/70 bg-white/85 p-6 shadow-2xl shadow-slate-200/80 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/72 dark:shadow-black/30 sm:p-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="interactive-lift flex h-12 w-full items-center justify-center rounded-xl bg-primary px-4 text-sm font-bold text-white shadow-lg shadow-primary/20 hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="interactive-lift flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-orange-300/50 bg-orange-50 px-4 text-sm font-bold text-orange-700 hover:border-orange-400 hover:bg-orange-100 disabled:cursor-not-allowed disabled:opacity-60 dark:border-orange-400/20 dark:bg-orange-400/10 dark:text-orange-300 dark:hover:bg-orange-400/15"
              >
            ...
            <div className="mt-7 flex flex-col gap-2 text-center text-sm text-slate-500 dark:text-slate-400">
              <Link href="/auth/register" className="font-bold text-primary transition-colors hover:text-primary-hover dark:text-teal-300">
