...
export default function AdminRevocationsPage() {
  ...
  async function revoke() {
    ...
    if (!window.confirm(`Thu hồi vĩnh viễn văn bằng ${selected.serialNumber || selected.certificate_id} trên blockchain?`)) return;
    try {
      setSubmitting(true);
